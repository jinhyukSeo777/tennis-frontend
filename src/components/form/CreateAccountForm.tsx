...
import { toggleCreate } from "../../counterSlice";
...
const CreateAccountForm = () => {
  ...
  const onSubmitValid = () => {
    const { username, password, email, summary } = getValues();
    createAccount({
      variables: { username, password, email, summary },
    });
  };
  ...
  return (
    ...
    >
      <LoginBox>
        <LoginBoxHeader>
          <span>WELCOME</span>
          <span onClick={() => dispatch(toggleCreate())}>
        ...
        <LoginBoxContent>
          ...
          <Form onSubmit={handleSubmit(onSubmitValid)}>
            ...
            <Input
              {...register("summary")}
              name="summary"
              isvalid={!errors?.summary ? "true" : "false"}
              type="summary"
